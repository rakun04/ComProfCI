            ...
            <div class="col-xs-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <u><h4>Deskripsi Data Center</h4></u>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#formJ').on('submit', function (e) {
            ...
            var url;
            if (save_method == 'add') {
                url = "<?=base_url().'Video/updateDeskripsi';?>";
            } else {
            ...
            <div class="modal-body">
                <form class="form" id="formJ" action="#" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="deskripsi" id="editor" class="form-control" data-iconlibrary="fa" rows="10" required><?php echo htmlspecialchars(set_value('deskripsi'));?><?=$detail->desc_data_center?></textarea>
                    </div>
            </div>
