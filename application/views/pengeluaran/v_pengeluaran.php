        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
							<button class="btn btn-danger btn-sm pull-left" onclick="addPengeluaran()"><i class="fa fa-plus"></i> | Tambah Pengeluaran</button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<script>
    ...
    $(document).ready(function () {
      table =  $('#tabel').DataTable({
                    ...
                    "ajax": {
                        "url": "<?php echo base_url().'Pengeluaran/ajax_list'?>",
                        "type": "POST"
                    },
...
<script type="text/javascript">
      ...
      $('#formJ').on('submit', function(e){
        ...
        function updatePengeluaran(id)
        {
            ...
            $.ajax({
                url : "<?=base_url().'Pengeluaran/get/'?>"+id,
                type : "GET",
                dataType : "JSON",
                success : function(data)
                {
                ...
                <div class="modal-body">
                    <form class="form" id="formJ" action="#" method="post">
                  	...
                  	<label class="">Description</label>
		                	<textarea name="deskripsi" id="editor" class="form-control" data-iconlibrary="fa" rows="3" required></textarea>
		                </div>
                </div>
